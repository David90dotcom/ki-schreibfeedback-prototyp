...
Zusätzlich kann die gesamte vorhandene Meta-Auswertung als versionierte JSON-Datei zwischen zwei Installationen übertragen werden. Der JSON-Export enthält die bewerteten Feedbackläufe einschließlich Aufgaben-Snapshot, anonymisiertem Schülertext, erzeugtem Feedback, Messwerten und vollständigen manuellen oder automatischen Meta-Bewertungen; API-Keys sind nicht Bestandteil der Datei. Beim Import werden Feedbackläufe und Bewertungen mit neuen internen IDs als unabhängige Kopien ergänzt, ohne vorhandene Daten zu überschreiben. Für die tabellarische Auswertung steht daneben ein semikolongetrennter CSV-Export bereit. Er enthält Zuordnungen, Anbieter, Modelle, Laufzeiten, die vier numerischen Kriterienwerte und den berechneten Mittelwert, aber weder Schüler- und Feedbacktexte noch die schriftlichen Begründungen. Die CSV-Datei ist kein Wiedereinleseformat.
